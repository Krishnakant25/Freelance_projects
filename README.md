...
| [`04-secure-mcp-agent`](04-secure-mcp-agent/) | Agent that runs tools on real files and endpoints without the lethal trifecta. Prompt injections fail because the capability was never granted, not because the attack text was recognised — verified by ablation | 191 + 200 red-team |
